...
# 4. Separate Numberical and categorical Columns
...
# print(f"The root mean sqared error for Linear Regression is {lin_rmse}.")
...
# print(f"The root mean sqared error for Decision Tree is {dec_rmses}.")
...
# print(f"The root mean sqared error for Random Forest is {random_forest_rmse} .")
